<template>
  <div
    class="relative rounded-3xl overflow-hidden group border border-transparent bg-gradient-to-br from-blue-100 via-white to-purple-100 dark:from-gray-900 dark:via-blue-950 dark:to-purple-900 shadow-xl hover:shadow-2xl transition-all duration-500 backdrop-blur-xl h-88 sm:h-[450px] md:h-[480px] lg:h-[520px] flex flex-col"
  >
