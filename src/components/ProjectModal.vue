    ...
    >
      <div class="relative">
        <img 
          ...
          :alt="project.title"
          class="w-full h-48 sm:h-64 md:h-80 object-cover rounded-t-2xl"
        >
        ...
        <div class="absolute top-4 left-4">
          <span class="px-3 py-1 bg-white dark:bg-gray-800 text-blue-700 dark:text-blue-300 text-xs font-semibold rounded-full shadow border border-blue-200 dark:border-blue-700">
            {{ project.category }}
          </span>
        </div>
      </div>
      <div class="p-5 sm:p-8 overflow-y-auto max-h-[calc(92vh-12rem)]">
        <div class="max-w-2xl mx-auto">
          ...
          <div v-if="project.longDescription" class="mb-8">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">About This Project</h3>
