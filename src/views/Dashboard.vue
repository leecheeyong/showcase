<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <header
      class="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 sticky top-0 z-40 backdrop-blur-xl bg-white/90 dark:bg-gray-900/90"
    >
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center gap-3">
            <div
              class="w-9 h-9 bg-blue-600 rounded-xl flex items-center justify-center"
            >
              <img src="https://joe.js.org/assets/joelee.png" alt="Logo" class="w-7 h-7 rounded-full" />
            </div>
            <div>
          ...
          <div class="flex items-center gap-4">
            <span
              class="hidden sm:flex items-center gap-2 px-3 py-1 bg-blue-50 dark:bg-blue-900/20 rounded-full text-xs text-blue-700 dark:text-blue-300 font-medium"
            >
              <span
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
        ...
        <div class="xl:col-span-8">
          <div
            class="bg-white dark:bg-gray-900 rounded-xl shadow border border-gray-100 dark:border-gray-800 p-5 mb-8"
          >
          ...
          <div class="space-y-6">
            <div v-if="loading" class="flex justify-center py-12">
              <div class="relative">
                <div
                  class="w-12 h-12 border-4 border-gray-100 dark:border-gray-800 rounded-full"
                ></div>
                <div
            ...
            >
              <div
                class="w-20 h-20 bg-gray-100 dark:bg-gray-900 rounded-xl flex items-center justify-center mx-auto mb-4"
              >
                <svg
            ...
            <div v-else class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              >
                <div class="relative h-44 overflow-hidden">
                  <template v-if="isVideoType(project.images[0])">
                    <video
                      :src="
                        project.images[0] ||
                  ...
                  <div class="absolute top-3 left-3">
                    <span
                      class="px-3 py-1 bg-white dark:bg-gray-900 text-blue-700 dark:text-blue-300 text-xs font-semibold rounded-full shadow border border-blue-200 dark:border-blue-700"
                    >
                      {{ project.category }}
                    </span>
                  </div>
                ...
                <div class="p-5">
                  <h3
                    class="text-base font-bold text-gray-900 dark:text-white mb-2 line-clamp-1"
                  >
                    {{ project.title }}
                  </h3>
                  <p
...
const filteredProjects = computed(() => {
  ...
  if (filterCategory.value) {
    filtered = filtered.filter(
      (project) => project.category === filterCategory.value,
    );
  }
